...
data "vault_generic_secret" "database" { path = "secret/prod/database" }
data "vault_generic_secret" "cache" { path = "secret/prod/cache" }
data "vault_generic_secret" "monitoring" { path = "secret/prod/monitoring" }
